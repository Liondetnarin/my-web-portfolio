...
export const skillGroups: SkillGroup[] = [
  ...
  { id: "data", name: "Data", shortName: "03", description: "Data foundations that keep products useful after launch." },
...
export const skillItems: SkillItem[] = [
  ...
  { id: "supabase", name: "Supabase / PostgreSQL", group: "data", icon: "/images/icon-svg/supabase-icon.svg", description: "A hosted PostgreSQL data layer used for product data and commerce workflows.", projectSlugs: ["luck-ju"] },
